...
var HomeService = /** @class */ (function () {
    function HomeService() {
        ...
        this._personalRecPlaces = [
            new _place_model__WEBPACK_IMPORTED_MODULE_2__["Place"]('p1', '412 Woodlands St 41', '730412', 'https://hybecorp.com/archive/YyQ6AuOnVuWtyBcnSPWW7UCNE7iZNNEDk9x8r01Eo0kOAWgMvS2hExwGhRFHZByiAtdJdOJS8NM4CjIXlkNHx016KMlDqmKfTJ8R8Tf7W8PuRxisViOGRFszt7ELmq9u.jpg'),
        ];
        this._trendRecPlaces = [
            new _place_model__WEBPACK_IMPORTED_MODULE_2__["Place"]('p2', '424B Yishun Ave 11', '762424', 'https://cdn.shopify.com/s/files/1/0231/1294/1648/articles/Pokemon_Center1_700x.jpg?v=1630683901'),
            new _place_model__WEBPACK_IMPORTED_MODULE_2__["Place"]('p3', '601 Ang Mo Kio Ave 5', '560601', 'https://phantom-marca.unidadeditorial.es/405632f5ad74b20e7db78c1401cc4afa/crop/119x0/1848x1154/resize/660/f/webp/assets/multimedia/imagenes/2022/11/14/16684588334944.png'),
        ];
    }
    Object.defineProperty(HomeService.prototype, "favPlaces", {
        get: function () {
            return __spreadArrays(this._favPlaces);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(HomeService.prototype, "personalRecPlaces", {
        get: function () {
            return __spreadArrays(this._personalRecPlaces);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(HomeService.prototype, "trendRecPlaces", {
        get: function () {
            return __spreadArrays(this._trendRecPlaces);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(HomeService.prototype, "recPlaces", {
        get: function () {
            var _a;
            return __spreadArrays((_a = this._personalRecPlaces).concat.apply(_a, this._trendRecPlaces));
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(HomeService.prototype, "allPlaces", {
        get: function () {
            var _a;
            return this._allPlaces = __spreadArrays((_a = this._favPlaces).concat.apply(_a, __spreadArrays(this._personalRecPlaces, this._trendRecPlaces)));
        },
        enumerable: true,
        configurable: true
    });
    HomeService.prototype.getPlace = function (postal) {
        return __assign({}, this._allPlaces.find(function (p) { return p.postal === postal; }));
    };
    HomeService.prototype.searchPlace = function (postal) {
        var targetPlace;
        targetPlace = this._allPlaces.find(function (p) { return p.postal === postal; });
        //console.log(targetPlace);
        return targetPlace;
    };
    HomeService.prototype.removeFavPlace = function (postal) {
        var updatePlaces;
        updatePlaces = this._favPlaces.filter(function (place) { return place.postal !== postal; });
        return updatePlaces;
    };
    HomeService.prototype.addFavPlace = function (postal) {
        var targetPlace;
        targetPlace = this.recPlaces.filter(function (place) { return place.postal === postal; });
        return this._favPlaces = this._favPlaces.concat(targetPlace);
    };
    HomeService.prototype.getBlockUnits = function (postal) {
        if (postal === void 0) { postal = '470142'; }
        var blockUnits;
        var targetPlace;
        targetPlace = this._allPlaces.find(function (p) { return p.postal === postal; });
    ...
    HomeService.prototype.searchUnit = function (postal, unitNo) {
        if (postal === void 0) { postal = '470142'; }
        var blockUnits;
        var targetUnit;
        blockUnits = this.getBlockUnits(postal);
        targetUnit = blockUnits.find(function (p) { return p.unitNum === unitNo; });
